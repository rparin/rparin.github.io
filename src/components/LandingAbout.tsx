  ...
  return (
    <>
      <Link
        ...
        replace={true}
        href="/"
        className="horizontal-mask absolute left-5 top-2.5 z-60 flex select-none gap-1 bg-background px-3 text-center hover:text-accent active:text-active dark:hover:text-accent dark:active:text-active md:fixed md:left-10">
        &lt; {AboutGen.Initials} /&gt;
      </Link>
